...
const Prediction = (props: Props) => {
    ...
    const formattedData = useMemo(() =>{
        ...
        return monthData.map(({month, revenue}, i:number) =>{
            return{
                ...
                "Predicted Revenue": regressionLine.predict(i+12)[1]//represents revenue value for next year
            }
        })
    ...
    return ( 
        <DashboardBox width="100%" height="400px" p="1rem" overflow="hidden" >
            ...
            <FlexBetween m="1rem 2.5rem" gap="1rem" >
                ...
                <Button 
                    ...
                    sx={{color: palette.grey[900],
                        ...
                        boxShadow: "0.1rem 0.1rem 0.1rem 0.1rem rgb(0,0,0,.4)"
